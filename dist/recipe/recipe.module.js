...
let RecipeModule = exports.RecipeModule = class RecipeModule {
};
exports.RecipeModule = RecipeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([recipe_entity_1.RecipesEntity, ingredient_entity_1.IngredientsEntity]),
        ],
