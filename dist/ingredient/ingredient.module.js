...
let IngredientModule = exports.IngredientModule = class IngredientModule {
};
exports.IngredientModule = IngredientModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([ingredient_entity_1.IngredientsEntity])],
        controllers: [ingredient_controller_1.IngredientsController],
